      ...
      <div className={style.banner}>
        ...
        >
          ...
          <div className={style.banner_heading}>
            <h1>Your path is illuminated by a road-map of stars.</h1>
          </div>
          <div className={style.banner_description}>
            <h3>Learn about astrology, zodiac signs, retrogrades, and more! Your world becomes clear once you understand how the universe influences it.</h3>
          </div>
